...
const Form = () => {
  ...
  return (
    ...
    >
      ...
      {section === 1 && (
        <Formone section={section} setSection={setSection} handleBack={handleBack}/>
        // <div className="block">
      ...
      {section === 2 && (
                <Formtwo section={section} setSection={setSection} handleBack={handleBack}/>
      ...
      {section === 3 && (
                <Formthree section={section} setSection={setSection} handleBack={handleBack}/>
